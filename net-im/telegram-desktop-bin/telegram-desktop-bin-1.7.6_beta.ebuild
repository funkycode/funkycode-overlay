...
EAPI=6
inherit desktop gnome2-utils xdg versionator

DESCRIPTION="Official desktop client for Telegram (binary package)"
HOMEPAGE="https://desktop.telegram.org"
MY_PV=$(replace_version_separator '_' '.' ${PVR}) #${PV}.${PR}
SRC_URI="
	https://updates.tdesktop.com/tlinux/tsetup.${MY_PV}.tar.xz -> tdesktop-${PV}.tar.xz
	amd64? ( https://updates.tdesktop.com/tlinux/tsetup.${MY_PV}.tar.xz )
	x86? ( https://updates.tdesktop.com/tlinux32/tsetup32.${MY_PV}.tar.xz )
"
