...
# $Header: /var/cvsroot/gentoo-x86/sys-auth/libfprint/libfprint-0.5.1-r1.ebuild,v 1.3 2014/07/30 19:40:24 ssuominen Exp $
...
#SRC_URI="http://cgit.freedesktop.org/${PN}/${PN}/snapshot/${MY_PV}.tar.xz -> ${P}.tar.xz"
SRC_URI="http://people.freedesktop.org/~hadess/libfprint-0.6.0.tar.xz"
...
src_prepare() {
#	epatch "${FILESDIR}/${P}-add-vfs5011-driver.patch" || die
	eautoreconf
}
