...
src_prepare() {
	...
	rm -rf nvidia-modprobe && mv nvidia-modprobe{-${PV},} || die
	rm -rf nvidia-persistenced && mv nvidia-persistenced{-${PV},} || die
	rm -rf nvidia-settings && mv nvidia-settings{-${PV},} || die
	rm -rf nvidia-xconfig && mv nvidia-xconfig{-${PV},} || die
